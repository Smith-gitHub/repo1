...
<head>
    ...
    <title>后台管理器</title>
    <meta name="description" content="后台管理器">
    <meta name="keywords" content="后台管理器">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="admin.jsp"><i class="fa fa-dashboard"></i> 首页</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="订单编号" value="${order.orderNum}" disabled="disabled">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker-a3" value="${order.orderTimeStr}" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-md-2 title">路线名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="路线名称" value="${order.product.productName}" disabled="disabled">
                        </div>

                        <div class="col-md-2 title">出发城市</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="出发城市" value="${order.product.cityName}" disabled="disabled">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker-a6" value="${order.product.departureTimeStr}" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-md-2 title">出游人数</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="出游人数" value="${order.peopleCount}" disabled="disabled">
                        </div>
                        ...
                        <tbody>
                            <c:forEach items="${order.travellers}" var="traveller">
                                <tr>
                                    ...
                                    <td><%--<input type="text" size="10" value="姓名">--%>${traveller.name}</td>
                                    <td>
                ...
                <!--费用信息-->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-4 data text">
                                <c:if test="${order.orderStatus==1}"> ${order.payTypeStr}(${order.orderStatusStr})</c:if>
                                <c:if test="${order.orderStatus==0}"> ${order.orderStatusStr}</c:if>
                            </div>
