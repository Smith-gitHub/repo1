   ...
   <jsp:include page="aside.jsp"/>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/pages/admin.html"><i class="fa fa-dashboard"></i> 首页</a></li>
                <li><a href="#">商品管理</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form name="productForm" action="${pageContext.request.contextPath}/product/delProduct" method="post" onsubmit="return check();" >
                        <!-- 数据表格 -->
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" onclick="location.href='/pages/product-add.jsp'" title="新建"><i class="fa fa-file-o"></i> 新建</button>
                                        <button type="submit" class="btn btn-default delete" title="删除"><i class="fa fa-trash-o"></i> 删除</button>
