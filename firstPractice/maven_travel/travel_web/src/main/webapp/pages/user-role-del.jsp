...
<body class="hold-transition skin-green sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/user/delRole" onsubmit="return submit_sure()" method="post">
				<!-- 正文区域 -->
					...
					<table id="dataList" class="table table-bordered table-striped table-hover dataTable">
							<thead>
								<tr>
									...
									<input id="selall" 
										type="checkbox" class="icheckbox_square-green"></th>
