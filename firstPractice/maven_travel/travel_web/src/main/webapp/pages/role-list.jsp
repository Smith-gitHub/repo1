...
<body class="hold-transition skin-green sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/pages/admin.jsp"><i
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										<th style="padding-right: 0px" class="">ID</th>
										<th class="">角色名称</th>
										<th class="">描述</th>
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findPermissionByRoleId?id=${role.id}" class="btn bg-olive btn-xs">删除权限</a>			</td>
										</tr>
									</c:forEach>
								</tbody>
